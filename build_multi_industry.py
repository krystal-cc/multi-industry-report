...
<body class="min-h-screen text-slate-800 antialiased pb-16">
  ...
  <div style="max-width: 1200px; margin: 0 auto 14px auto; padding: 0 10px;">
    <div class="top-poster-mobile" style="background: #e8e2d0; color: #5a5347; border-radius: 16px; padding: 18px 24px; box-shadow: 0 6px 20px rgba(120,110,80,0.10); position: relative; overflow: hidden;">
      ...
      <div class="banner-inner" style="position: relative; z-index: 1; display: flex; align-items: center; justify-content: space-between; gap: 16px; flex-wrap: wrap;">
        <!-- 左侧：标题区 -->
        <div style="text-align: left; flex: 1 1 auto; min-width: 200px;">
