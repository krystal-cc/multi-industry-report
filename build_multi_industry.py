...
<head>
  ...
  <style>
    * {{ box-sizing: border-box; }}
    ...
    .panel-tab:hover:not(.active-panel-tab) {{
      color: #3d3527;
    ...
    .active-panel-tab {{
      ...
      box-shadow: 0 6px 16px rgba(30,41,59,0.28), inset 0 1px 0 rgba(255,255,255,0.15);
    }}
    ...
    .gold-line {{
      width: 48px;
      height: 2px;
      background: linear-gradient(90deg, #b89968, #d4c39d, #b89968);
    ...
    .top-banner {{
      background:
        linear-gradient(135deg, #f0ead8 0%, #e8e2d0 45%, #ddd5bf 100%);
      position: relative;
      overflow: hidden;
    }}
    .top-banner::before {{
    ...
    .top-banner::after {{
      ...
      background: radial-gradient(circle, rgba(184,153,104,0.12) 0%, transparent 65%);
      border-radius: 50%;
      pointer-events: none;
    }}
    ...
    <div class="top-poster-mobile top-banner" style="border-radius: 18px; padding: 22px 28px; box-shadow: 0 8px 24px rgba(120,110,80,0.12), inset 0 1px 0 rgba(255,255,255,0.4);">
      ...
      <div class="banner-inner" style="position: relative; z-index: 1; display: flex; align-items: center; justify-content: space-between; gap: 20px; flex-wrap: wrap;">
        ...
        <div style="text-align: left; flex: 1 1 auto; min-width: 220px;">
          <div style="font-size: 11px; font-weight: 600; letter-spacing: 3px; color: #8a6a2a; text-transform: uppercase; margin-bottom: 4px;">PDD · TRENDING PICKS</div>
